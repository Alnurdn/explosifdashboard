    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            Registrasi <small>Start Up Business</small>
                        </h1>
                        <ol class="breadcrumb">
                            <li class="active">
                ...
                <!-- Content -->
                <div class="col-lg-6">
                    <form method="post" action="<?php echo base_url()."index.php/bisnisregcont/add_bisnis_process"; ?>" role="form">
