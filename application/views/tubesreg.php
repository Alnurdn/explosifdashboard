    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            Registrasi <small>Tugas Besar</small>
                        </h1>
                        <ol class="breadcrumb">
                            <li class="active">
                ...
                <!-- Content -->
                <div class="col-lg-6">
                    <form method="post" action="<?php echo base_url()."index.php/tubesregcont/add_tubes_process"; ?>" role="form">
                        <div class="form-group">
                            <label>Mata Kuliah Tubes</label>
                            <select name="matkul" class="form-control">                                    
                                <option selected="selected">KPST</option>
                                <option>DAP</option>
                                <option>PBO</option>
                                <option>RPL</option>
                                <option>AI</option>
                                <option>RPL OOT</option>
                            </select>
                        </div>
                        <div class="form-group">
                            <label>Kelas</label>
                        ...
                        <div class="form-group">
                            ...
                            <input name="nimketua" class="form-control" placeholder="NIM Ketua">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input name="nimanggota1" class="form-control" placeholder="NIM Anggota 1">
                            <input name="nimanggota2" class="form-control" placeholder="NIM Anggota 2">
                            <input name="nimanggota3" class="form-control" placeholder="NIM Anggota 3">
                        </div>
                        <div class="form-group">
